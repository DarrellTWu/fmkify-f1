...
.fmk-cards-grid{flex:1;display:flex;gap:1rem;padding:0.5rem 1.5rem;justify-content:center;align-items:stretch;min-height:0}
...
.fmk-banner{flex:1;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;min-height:120px}
...
.fmk-banner .driver-photo{position:relative;z-index:2;width:75%;max-height:90%;object-fit:contain;object-position:center bottom;transition:opacity .5s;filter:drop-shadow(0 6px 20px rgba(0,0,0,.5))}
...
.fmk-info{padding:1rem 1.2rem .8rem;background:linear-gradient(to top,rgba(25,12,22,.98) 55%,rgba(25,12,22,.82))}
