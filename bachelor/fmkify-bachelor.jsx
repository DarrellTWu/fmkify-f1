...
// num = season number of their lead/contestant run; sub = display line on the card.
const CAST = [
  { id:1,  name:"Jesse Palmer",       team:"Host",             num:5,  sub:"S5 Lead · Now the Host" },
  { id:2,  name:"Jake Pavelka",       team:"The Bachelor",     num:14, sub:"Season 14 · The Pilot" },
  { id:3,  name:"Brad Womack",        team:"The Bachelor",     num:15, sub:"Seasons 11 & 15" },
  { id:4,  name:"Sean Lowe",          team:"The Bachelor",     num:17, sub:"Season 17" },
  { id:5,  name:"Juan Pablo Galavis", team:"The Bachelor",     num:18, sub:"Season 18" },
  { id:6,  name:"Ben Higgins",        team:"The Bachelor",     num:20, sub:"Season 20" },
  { id:7,  name:"Nick Viall",         team:"The Bachelor",     num:21, sub:"Season 21 · 4x Contestant" },
  { id:8,  name:"Arie Luyendyk Jr.",  team:"The Bachelor",     num:22, sub:"Season 22" },
  { id:9,  name:"Colton Underwood",   team:"The Bachelor",     num:23, sub:"Season 23" },
  { id:10, name:"Peter Weber",        team:"The Bachelor",     num:24, sub:"Season 24 · Pilot Pete" },
  { id:11, name:"Matt James",         team:"The Bachelor",     num:25, sub:"Season 25" },
  { id:12, name:"Clayton Echard",     team:"The Bachelor",     num:26, sub:"Season 26" },
  { id:13, name:"Zach Shallcross",    team:"The Bachelor",     num:27, sub:"Season 27" },
  { id:14, name:"Joey Graziadei",     team:"The Bachelor",     num:28, sub:"Season 28" },
  { id:15, name:"Grant Ellis",        team:"The Bachelor",     num:29, sub:"Season 29" },
  { id:16, name:"Jordan Rodgers",     team:"The Bachelorette", num:12, sub:"JoJo's Winner" },
  { id:17, name:"Wells Adams",        team:"Paradise",         num:12, sub:"The Bartender" },
...
// ── Vote quips ─────────────────────────────────────────────────
const QUIPS = {
  1:  { f:"The host finally gets a rose of his own",              m:"You're marrying into every season simultaneously",         k:"Ladies… this is the final rose tonight" },
  2:  { f:"On the wings of love (round trip not included)",       m:"Fasten your seatbelt — permanent turbulence",              k:"Cleared for final descent" },
  3:  { f:"He can commit to exactly one night",                   m:"He turned down two finalists — you're built different",    k:"He would've chosen no one anyway" },
  4:  { f:"The born-again virgin will need a moment to pray",     m:"Statistically the only safe marriage in franchise history",k:"Catherine and three kids will avenge him" },
  5:  { f:"Besos. So many besos.",                                m:"He won't say 'I love you.' He'll say 'ees okay.'",         k:"Ees okay. Nobody in Bachelor Nation is mad." },
  6:  { f:"The nicest situationship you'll ever have",            m:"He'll say 'I love you' — to you and maybe one other",      k:"He already thought he was unlovable. Congrats." },
  7:  { f:"You'll be a segment on The Viall Files by Monday",     m:"It took him four seasons to get here — he's not leaving",  k:"Rejected on national TV twice. He'll survive you." },
  8:  { f:"Fast laps, faster exits",                              m:"He'll propose. Then un-propose. On camera.",               k:"He'll dump you for the runner-up in a two-hour special" },
  9:  { f:"Worth jumping a fence for",                            m:"Expect a Netflix documentary about it",                    k:"He's jumped fences for less" },
  10: { f:"The windmill already told everyone",                   m:"You'll have to get through Barb first",                    k:"His mom saw it coming. Loudly." },
  11: { f:"He'll take you bungee jumping on the first date",      m:"Wedding vlog incoming",                                    k:"Bachelor Nation didn't deserve him anyway" },
  12: { f:"He was intimate with both of you",                     m:"He'll love you. And two other people. Equally.",           k:"Susie left first and she was right" },
  13: { f:"He'll break his own fantasy-suite rule for you",       m:"The most respectful husband in franchise history",         k:"A very polite elimination" },
  14: { f:"Tennis pro — love means nothing to him",               m:"The golden retriever of Bachelor Nation said yes",         k:"All of Bachelor Nation AND the DWTS judges object" },
  15: { f:"Buy low, sell high, swipe right",                      m:"A blue-chip, long-term hold",                              k:"Portfolio rebalancing gone wrong" },
  16: { f:"Touchdown dance optional",                             m:"Thanksgiving with the Rodgers family (Aaron isn't coming)",k:"Aaron won't return that call either" },
  17: { f:"The bartender always knows what you need",             m:"Sarah Hyland got there first, but dream big",              k:"Who's going to make the drinks in Paradise now?!" },
...
// ── Storage ─────────────────────────────────────────────────────
// API_BASE: set to "/api/bachelor" for the /bachelor subpath deployment,
// or to a full URL (e.g. "https://www.fmkify.com/api/bachelor") during local dev.
const API_BASE = "/api/bachelor";
...
function RankingsView({onBack,globalData}) {
  ...
  return (
    <div className="fmk-rankings-shell">
      <div className="fmk-topbar">
        <div className="fmk-logo"><span onClick={()=>{window.location.href="/";}} style={{cursor:'pointer'}} title="FMKify home">🏆 <span className="accent">FMKify</span></span><span onClick={onBack} style={{cursor:'pointer'}} title="Back to game"> Bachelor Rankings</span></div><div/>
...
function Footer() {
  return (
    <div className="fmk-footer">
      ...
      <div className="footer-row">
        <a href="/nba/" className="footer-cta">🏀 Also live: FMKify NBA →</a>
        <span className="footer-sep">·</span>
...
export default function App() {
  ...
  const navigateTo = useCallback((target) => {
    const path = target === "rankings" ? "/bachelor/rankings/" : "/bachelor/";
...
.fmk-banner .player-photo{position:relative;z-index:2;width:100%;height:100%;object-fit:cover;object-position:center 12%;display:block;transition:opacity .5s}
...
@media(max-width:768px){
  ...
  .fmk-card .fmk-banner .player-photo{width:100%;height:100%;object-fit:cover;object-position:center 12%}
